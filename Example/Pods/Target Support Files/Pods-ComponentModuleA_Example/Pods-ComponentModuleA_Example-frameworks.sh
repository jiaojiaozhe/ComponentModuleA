...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ComponentModuleA/ComponentModuleA.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/LogicBaseComponentModule/LogicBaseComponentModule.framework"
